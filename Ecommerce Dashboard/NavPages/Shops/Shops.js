...
const loadShopProducts = async () => {
    ...
    const productCardDiv = document.querySelector(".shopProductCardDiv");
    ...
    productCardDiv.innerHTML += `
        <div class="shopProductCard">
            ...
            <div class="productCard_content">
                ...
                <div class="shopProductCardBtns">
                    <a href="../../Products/product.html?id=${product.id}" class="ViewProductBtn">View Product</a>
                    <button class="shopGridCartBtn addToCartBtn" data-id="${product.id}">Add to Cart</button>
                </div>
            </div>
        </div>
        `;
